...
<body>
    ...
    <div class="container my-5 mt-3 d-flex flex-column p-0 w-50 bg-white border-radius-20 shadow-heavy">
        <div class = "d-flex">
                ...
                <div class="p-4 align-items-center d-flex flex-column">
                    ...
                    <form method = "post" class = "align-items-center d-flex flex-column w-100" enctype="multipart/form-data">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <button type="submit" class="py-3 btn" name = "googleSignin"><img src="assets/designImages/gmail-icon.png" alt="gmailIcon" width="50" class="g-img"></button>
                        </div>
                    </form>
                    ...
                    <cfoutput>
                        <cfif structKeyExists(form, "submit")>
                            ...
                            <cfloop collection ="#loginErrorMsg#" item="item">
                                <div class = "#item# fw-bold fs-3">#loginErrorMsg['#item#']#</div>
                            </cfloop>
                        </cfif>        
                    </cfoutput>
                </div>
